...
Welcome to today's video. Vui lòng khám phá “Breakthrough growth” trong sáng tạo nội dung.
...
.light-sweep-title {
    ...
    background: linear-gradient(90deg, #cbd5e1 0%, #ffffff 30%, #818CF8 50%, #ffffff 70%, #cbd5e1 100%);
    ...
    text-shadow: 0 0 25px rgba(129, 140, 248, 0.25);
...
def parse_and_render_script(text):
    ...
    # 2. Xử lý từ khóa Text Overlay trong ngoặc kép
...
if not st.session_state.logged_in:
    ...
    st.markdown("<p style='text-align: center; color: #94A3B8; margin-bottom: 30px;'>Hệ thống phân tích kịch bản thông minh & trích xuất nguyên liệu dựng phim.</p>", unsafe_allow_html=True)
